...
export default function Contact({hideContact}) {

  return (
    <div classname="contact_window" id="contact_window">
            <div classname="contact_box">
              <img classname="contact_img" src="./image/contact.jpg" alt="contact"/>
              <button classname="closebtn" onclick={hideContact}>×</button>
              <div classname="contact">
                <h1>CONTACT ME</h1>                
                <img src="./image/gmail-logo.png" alt="gmail"/> &nbsp; niranjan2257@gmail.com <br/><br/>
                <img src="./image/call.png" alt="call"/> &nbsp; +91 7909060717
                <h1>GET IN TOUCH</h1>
                <div>
                  <ul>
